...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-8 col-xs-12"><h2 style="color:grey"><i class="fa fa-medkit"></i> Services </h2></div>
    ...
    <script src="../../controller/services/main.js" type="text/javascript"></script>
