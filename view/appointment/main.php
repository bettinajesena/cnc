...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-10 col-xs-12"><h2 style="color:grey"><i class="fa fa-paw"></i> APPOINTMENT </h2></div>            
                </div>      
    ...
    <script src="../../controller/appointment/main.js" type="text/javascript"></script>
