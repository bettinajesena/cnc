...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-8 col-xs-12"><h2 style="color:grey"><i class="fa fa-medkit"></i>Discharge</h2></div>
            ...
            <?php include('discharge_main_form.html'); ?>
    ...
    <script src="../../controller/vaccines/main.js" type="text/javascript"></script>
